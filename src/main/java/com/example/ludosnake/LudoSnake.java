...
public class LudoSnake extends Application {
    ...
    public Pane createContent(){
        ...
        playerOne  = new Player(tileSize, Color.MAGENTA);
        ...
        gameButton.setOnAction(new EventHandler<ActionEvent>() {
            ...
            public void handle(ActionEvent actionEvent) {
                ...
                gameStart  = true;
                gameButton.setText("GAME GOING BRO");
            }
        });

        Image img = new Image("C:\\Users\\Yogii\\IdeaProjects\\LudoSnake\\src\\wp9141966.jpg");
    ...
    void gameOver(){
        ...
        {
            randResult.setText("Hurray! Player one --you won bro");
            gameButton.setText("Start Again");
            gameStart = false;
        }
        else if(playerTwo.getWinningStatus()==true)
        {
            randResult.setText("Hurray! Player Two --you won bro");
            gameButton.setText("Start Again");
            gameStart = false;
        }
    }
